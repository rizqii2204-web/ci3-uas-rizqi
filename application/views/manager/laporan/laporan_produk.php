...
<!-- FILTER -->
<form method="get" action="<?= base_url('index.php/manager/laporan_produk') ?>" class="mb-4">
    <div class="row align-items-end">
        ...
        <div class="col-md-3">
            ...
            <a href="<?= base_url('index.php/manager/laporan_produk') ?>" class="btn btn-secondary mt-4">
                Reset
            </a>
        </div>
        ...
        $link_pdf = base_url('index.php/manager/export_pdf_produk');
        ...
        <table class="table table-bordered">
            ...
            <tbody>
                <?php if (!empty($laporan_produk)) : ?>
                    <?php $no = 1; foreach ($laporan_produk as $row) : ?>
                    <tr>
                        <td><?= $no++ ?></td>
